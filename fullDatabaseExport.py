...
#Variables to adjust number of ECG
numberOfNormal = 40
numberOfEachSCP = 4
...
#--------------------------
file = open("00ptbxl_database.csv", "r")
...
#--------------------------
### CLEAN DATABASE BY EXCKLUSION/INCLUSION CRITERIAS
#--------------------------
patientIncluded = []
limitedDatabase = []
